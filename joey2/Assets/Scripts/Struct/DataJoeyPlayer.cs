...
public class DataJoeyPlayer : IData
{
	...
	public void LoadFromJson(JObject jobject)
	{
		...
		EnvDifficultyLevel = jobject.ContainsKey("EnvDifficultyLevel") ? (int)jobject["EnvDifficultyLevel"] : 1;
	...
	public void SaveToJson(JObject jobject)
	{
		...
		jobject.Add("EnvDifficultyLevel", EnvDifficultyLevel);
