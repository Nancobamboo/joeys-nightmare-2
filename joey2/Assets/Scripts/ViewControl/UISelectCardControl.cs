...
public class UISelectCardControl : YViewControl
{
    ...
    public System.Action<UISelectCardControl> SelectClickHandler; // Click event callback
    ...
    void OnBtnCardClick()
    {
        SelectClickHandler?.Invoke(this);
    }
